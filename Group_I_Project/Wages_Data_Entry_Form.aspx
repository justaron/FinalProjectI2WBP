    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <table class="auto-style1">
                <tr>
                    <td class="auto-style12"><strong>Employee:</strong></td>
                    <td class="auto-style13">
                                    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSourceEmployee" DataTextField="Empl_Name" DataValueField="Empl_ID">
                                    </asp:DropDownList>
                                </td>
                ...
                <tr>
                    <td class="auto-style14"><strong>Wage Date:</strong></td>
                ...
                <tr>
                    <td class="auto-style16"><strong>Wage Amount:</strong></td>
                ...
                <tr>
                    <td class="auto-style18"><strong>Wage Commission:</strong></td>
            ...
            <asp:Button ID="Button1" runat="server" CssClass="auto-style24" Height="53px" OnClientClick="window.close()" Text="Close the Form" Width="208px" />
                ...
                <tr>
                    <td class="auto-style20" colspan="2">
                                    <asp:SqlDataSource ID="SqlDataSourceEmployee" runat="server" ConnectionString="<%$ ConnectionStrings:db_ZErenEsendemirConnectionString %>" SelectCommand="SELECT [Empl_ID], [Empl_Name] FROM [tbl_Employees]"></asp:SqlDataSource>
                    </td>
                    <td class="auto-style20" colspan="2">
                                    <asp:SqlDataSource ID="SqlDataSourceSAVEFORMWage" runat="server" ConnectionString="<%$ ConnectionStrings:db_ZErenEsendemirConnectionString %>" InsertCommand="INSERT INTO tbl_EmployeeWages(Empl_ID, Wage_Date, Wage_Amount, Wage_Commission) VALUES (@Empl_ID, @Wage_Date, @Wage_Amount, @Wage_Commission)" SelectCommand="SELECT [Empl_ID], [Wage_Date], [Wage_Amount], [Wage_Commission] FROM [tbl_EmployeeWages]">
                                        <InsertParameters>
