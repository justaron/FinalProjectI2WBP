            ...
            <table class="auto-style25">
                ...
                <tr>
                    ...
                    <td class="auto-style14">
                                    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSourceRoleID" DataTextField="Role" DataValueField="LK_ID">
                                    </asp:DropDownList>
                                </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style24" colspan="2">
                                    <asp:SqlDataSource ID="SqlDataSourceRoleID" runat="server" ConnectionString="<%$ ConnectionStrings:db_ZErenEsendemirConnectionString %>" SelectCommand="SELECT [Role], [LK_ID] FROM [tbl_Lookups]"></asp:SqlDataSource>
                    </td>
                </tr>
            </table>
        <asp:SqlDataSource ID="SqlDataSourceSAVEFORMUser" runat="server" ConnectionString="<%$ ConnectionStrings:db_ZErenEsendemirConnectionString %>" InsertCommand="INSERT INTO tbl_Users(User_Fname, User_Psw, Role_ID) VALUES (@User_Fname, @User_Psw, @Role_ID)" SelectCommand="SELECT User_Fname, User_Psw, Role_ID FROM tbl_Users">
            <InsertParameters>
