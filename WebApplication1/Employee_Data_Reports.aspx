    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:db_MKaanUykanConnectionString %>" SelectCommand="SELECT [Empl_ID], [Empl_Name], [Empl_BDate], [Empl_Start_Date], [Empl_Left_Date], [Empl_Address], [Empl_City], [Empl_Province], [Empl_Phone], [Empl_Cell], [Empl_EMail], [Dept_ID], [Gender_ID], [Title_ID], [Entered_By], [Entered_Date], [Is_Empl_Active] FROM [tbl_Employees]"></asp:SqlDataSource>
                    </td>
                    <td>&nbsp;</td>
                </tr>
            </table>
