...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            <tr>
                <td class="auto-style4"><strong>Employee Wage Graphic Report</strong></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:db_MKaanUykanConnectionString %>" SelectCommand="SELECT tbl_Employees.Empl_Name AS Name, SUM(tbl_EmployeeWages.Wage_Total) AS Total, tbl_EmployeeWages.Wage_Year AS Year FROM tbl_EmployeeWages INNER JOIN tbl_Employees ON tbl_EmployeeWages.Empl_ID = tbl_Employees.Empl_ID GROUP BY tbl_Employees.Empl_Name, tbl_EmployeeWages.Wage_Year"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td> <strong>
