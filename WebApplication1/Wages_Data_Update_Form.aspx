    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style4"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Select theWage ID:</strong></td>
                    <td class="auto-style6">
                        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSourceSelectWageEmployee" DataTextField="Empl_ID" DataValueField="Wage_ID">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style3">
                        <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="Wage_ID" DataSourceID="SqlDataSourceUpdateWage" Height="50px" Width="247px">
                            <Fields>
                                ...
                                <asp:BoundField DataField="Month_ID" HeaderText="Month_ID" ReadOnly="True" SortExpression="Month_ID" />
                ...
                <tr>
                    <td class="auto-style3">
                        <asp:SqlDataSource ID="SqlDataSourceUpdateWage" runat="server" ConnectionString="<%$ ConnectionStrings:db_MKaanUykanConnectionString %>" SelectCommand="SELECT [Wage_ID], [Empl_ID], [Wage_Date], [Wage_Amount], [Wage_Commission], [Wage_Total], [Month_ID], [Wage_Year] FROM [tbl_EmployeeWages] WHERE ([Wage_ID] = @Wage_ID)" UpdateCommand="UPDATE tbl_EmployeeWages SET Empl_ID = @Empl_ID, Wage_Date = @Wage_Date, Wage_Amount = @Wage_Amount, Wage_Commission = @Wage_Commission WHERE (Wage_ID = @Wage_ID)" DeleteCommand="DELETE FROM tbl_EmployeeWages
WHERE (Wage_ID = @Wage_ID)">
                    ...
                    <td>
                        <asp:SqlDataSource ID="SqlDataSourceSelectWageEmployee" runat="server" ConnectionString="<%$ ConnectionStrings:db_MKaanUykanConnectionString %>" SelectCommand="SELECT [Empl_ID], [Wage_ID] FROM [tbl_EmployeeWages]"></asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style3">
