        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="Button2" runat="server" CssClass="auto-style5" Height="54px" OnClientClick="window.close()" Text="Close the Form" Width="176px" />
                        </td>
                </tr>
                <tr>
                    <td class="auto-style6">&nbsp;</td>
                ...
                <tr>
                    <td class="auto-style7">
                        <asp:SqlDataSource ID="SqlDataSourceSelectDepartment" runat="server" ConnectionString="<%$ ConnectionStrings:db_MKaanUykanConnectionString %>" SelectCommand="SELECT [Dept_ID], [Dept_Name] FROM [tbl_Departments]"></asp:SqlDataSource>
                    </td>
                    <td class="auto-style8">
                        <asp:SqlDataSource ID="SqlDataSourceSaveDepartmentData" runat="server" ConnectionString="<%$ ConnectionStrings:db_MKaanUykanConnectionString %>" SelectCommand="SELECT [Dept_ID], [Dept_Name], [Dept_Phone], [Manager_ID] FROM [tbl_Departments] WHERE ([Dept_ID] = @Dept_ID)" UpdateCommand="UPDATE tbl_Departments SET Dept_Name = @Dept_Name, Dept_Phone = @Dept_Phone, Manager_ID = @Manager_ID
