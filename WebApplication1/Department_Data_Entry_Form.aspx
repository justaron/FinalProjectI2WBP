    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style14" colspan="3"><strong>Dept_Name:</strong></td>
                    <td class="auto-style13">
                                    <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
                                </td>
                </tr>
                <tr>
                    <td class="auto-style15" colspan="3"><strong>Dept_Phone:</strong></td>
                    <td class="auto-style16">
                                    <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                                </td>
                </tr>
                <tr>
                    <td class="auto-style17" colspan="3"><strong>Manager_ID:</strong></td>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style17">
                        &nbsp;</td>
                    <td class="auto-style17">
                                    <asp:SqlDataSource ID="SqlDataSourceDeptName" runat="server" ConnectionString="<%$ ConnectionStrings:db_MKaanUykanConnectionString %>" SelectCommand="SELECT [Dept_Name] FROM [tbl_Departments]"></asp:SqlDataSource>
                                    <asp:SqlDataSource ID="SqlDataSourceSAVEFORMDepartment" runat="server" OnSelecting="SqlDataSourceSAVEFORMDepartment_Selecting" ConnectionString="<%$ ConnectionStrings:db_MKaanUykanConnectionString %>" InsertCommand="INSERT INTO tbl_Departments(Dept_Name, Dept_Phone, Manager_ID) VALUES (@Dept_Name, @Dept_Phone, @Manager_ID)" SelectCommand="SELECT [Dept_Name], [Dept_Phone], [Manager_ID] FROM [tbl_Departments]">
                                        <InsertParameters>
                    ...
                    <td class="auto-style17" colspan="2">
                                    <asp:SqlDataSource ID="SqlDataSourceManagerID" runat="server" ConnectionString="<%$ ConnectionStrings:db_MKaanUykanConnectionString %>" SelectCommand="SELECT [Manager_ID] FROM [tbl_Departments]"></asp:SqlDataSource>
                    </td>
                </tr>
            </table>
        </div>
